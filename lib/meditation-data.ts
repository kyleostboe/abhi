...
export const INSTRUCTIONS_LIBRARY: Instruction[] = [
  // Metta Instructions (as per image)
  {
    id: "metta-1",
  ...
  {
    id: "mindfulness-1",
    text: "Observe the breath",
    category: "Mindfulness",
  },
  {
    id: "mindfulness-2",
    text: "Notice thoughts as they come and go",
    category: "Mindfulness",
  },
  // Nonduality Instructions
  {
    id: "nonduality-1",
    text: "Rest in awareness",
    category: "Nonduality",
  },
  {
    id: "nonduality-2",
    text: "Recognize the unity of all experience",
    category: "Nonduality",
  },
  // Transition Instructions
  {
    id: "transitions-1",
    text: "Prepare for the next segment",
    category: "Transitions",
  },
  {
    id: "transitions-2",
    text: "Gently bring your attention back to the present moment",
    category: "Transitions",
  },
]
