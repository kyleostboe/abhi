      ...
      >
        <div className="relative overflow-hidden">
          ...
          <div className="px-6 md:px-10 pb-10 font-serif font-black">
            ...
            <form className="space-y-6 bg-white p-8 rounded-xl shadow-lg dark:bg-gray-900 dark:shadow-white/10">
              <div>
                ...
                <Input
                  ...
                  id="name"
                  name="name"
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
              ...
              <Button
                type="submit"
                className="w-full py-3 text-lg font-medium tracking-wider rounded-xl transition-all shadow-lg dark:shadow-white/20 hover:shadow-none active:shadow-none bg-gradient-to-r from-logo-teal-500 to-logo-purple-500 text-white dark:from-logo-teal-700 dark:to-logo-purple-700"
              >
                Send Message
              </Button>
            </form>
