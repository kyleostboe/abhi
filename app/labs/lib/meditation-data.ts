\
{
  Instruction as ImportedInstruction, SoundCue as ImportedSoundCue
  \
}
from
;("./types")
...
export const MUSICAL_NOTES = \
{
  ...
  ,
    \
  id: "mind-a4-return", name
  : "A4 (return)", note: "A", octave: 4 \
  ,
  ],
  Nonduality: [
    \
        ...
        () => \{
          try \{
            ...
            if (audioContext.state !== 'closed') \{
              // Disconnect nodes to prevent memory leaks, but don't close the shared context
