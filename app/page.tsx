          ...
          <div className="relative text-center px-6 pt-16">
            ...
            >
              ...
              <div className="flex flex-col items-center space-y-4 my-12">
                <div className="grid w-full grid-cols-2 bg-gray-100/70 p-1 rounded-md dark:bg-gray-800/70">
                  <button
                    onClick={() => setActiveMode("adjuster")}
                    className={cn(
                      "inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-xs font-black",
                      activeMode === "adjuster"
