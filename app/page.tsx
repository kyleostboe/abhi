            ...
            {activeMode === "adjuster" ? (
              ...
              <>
                ...
                <motion.div
                  ...
                  onDrop={handleDrop}
                >
                  <div className="bg-gradient-to-r from-logo-pink to-logo-blue to-logo-green py-3 px-6 dark:from-logo-pink dark:to-logo-blue dark:to-logo-green border-dashed border-0">
