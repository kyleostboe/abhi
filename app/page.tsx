...
const [actualDuration, setActualDuration: React.Dispatch<React.SetStateAction<number | null>>]
null
\
const [isProcessingComplete, setIsProcessingComplete: React.Dispatch<React.SetStateAction<boolean>>]
false
\
const [isMobileDevice, setIsMobileDevice: React.Dispatch<React.SetStateAction<boolean>>]
false
\
const [memoryWarning, setMemoryWarning: React.Dispatch<React.SetStateAction<boolean>>]
false
