            ...
            {activeMode === "adjuster" ? (
              ...
              <>
                ...
                <motion.div
                  ...
                  onDrop={handleDrop}
                >
                  <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 py-3 px-6 dark:from-purple-700 dark:via-pink-700 dark:to-red-700 border-dashed border-0">
