      ...
      >
        ...
        <div className="px-6 md:px-10 pb-10 font-serif font-black">
          <div className="grid gap-6 md:grid-cols-2">
            <Link href="/adjuster" className="block">
              <Button className="w-full py-7 text-lg font-medium tracking-wider rounded-xl transition-all shadow-lg dark:shadow-white/20 hover:shadow-none active:shadow-none bg-gradient-to-r from-logo-teal-500 to-indigo-500 text-white dark:from-logo-teal-700 dark:to-indigo-700">
                Length Adjuster
              </Button>
            </Link>
            <Link href="/encoder" className="block">
              <Button className="w-full py-7 text-lg font-medium tracking-wider rounded-xl transition-all shadow-lg dark:shadow-white/20 hover:shadow-none active:shadow-none bg-gradient-to-r from-logo-rose-500 to-logo-purple-500 text-white dark:from-logo-rose-700 dark:to-logo-purple-700">
                Encoder (Labs)
              </Button>
            </Link>
          </div>
