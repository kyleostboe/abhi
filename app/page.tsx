                  ...
                  <TabsContent value="basic" className="mt-0 space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <Card className="overflow-hidden border-none shadow-lg dark:shadow-white/20 bg-white dark:bg-gray-900">
                        <div className="bg-gradient-to-r from-logo-rose-500 to-logo-emerald-500 py-3 px-6 dark:from-logo-teal-700 dark:to-indigo-700">
                        ...
                        <div className="p-6 py-6 px-11">
                          <div className="mb-4">
                            <Slider
                              ...
                              className="py-4"
                              rangeClassName="bg-gradient-to-r from-logo-rose-500 to-logo-emerald-500 dark:from-logo-teal-700 dark:to-indigo-700"
                            />
                          </div>
                      ...
                      <Card className="overflow-hidden border-none shadow-lg dark:shadow-white/20 bg-white dark:bg-gray-900">
                        <div className="bg-gradient-to-r from-logo-blue-500 to-logo-amber-500 py-3 px-6 dark:from-indigo-700 dark:to-logo-teal-700">
                        ...
                        <div className="p-6 px-11">
                          <div className="mb-4">
                            <Slider
                              ...
                              className="py-4"
                              rangeClassName="bg-gradient-to-r from-logo-blue-500 to-logo-amber-500 dark:from-indigo-700 dark:to-logo-teal-700"
                            />
                          </div>
                      ...
                      <Card className="overflow-hidden border-none shadow-lg dark:shadow-white/20 bg-white dark:bg-gray-900">
                        ...
                        <div className="p-6 px-11 py-6">
                          ...
                          <div className="text-center">
                            ...
                            <span className="ml-1 dark:text-logo-teal-400 text-basee text-base text-gray-600">seconds</span>
                          </div>
              ...
              >
                <Button
                  className={cn(
                    ...
                    "bg-[linear-gradient(90deg,#38C79B_0%,#40C9B7_12%,#38BFF2_36%,#C099F9_64%,#38C79B_100%)]",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="p-0.5 bg-gradient-to-r from-logo-teal-500 to-logo-purple-500 border-indigo-200 rounded-2xl shadow-md border-0 py-[5px] px-[5px]">
                    ...
                    <div className="p-6 space-y-4">
                      <div className="text-left">
                        <Label
                          ...
                          className="text-gray-600 dark:text-logo-rose-400 font-black"
                        >
                          Label
                        </Label>
                        <Input
                          ...
                          className="mt-1 text-sm font-black text-gray-600 placeholder-gray-500 border-2"
                        />
                      </div>
                      <Button
