              ...
              icon={
                isLoading ? (
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                    <path
                      fillRule="evenodd"
                      d="M6.75 5.25a3 3 0 013 3v1.5h3a3 3 0 013 3v1.5a3 3 0 01-3 3h-3v1.5a3 3 0 01-3 3A3 3 0 013.75 16.5v-1.5H.75a3 3 0 01-3-3V9a3 3 0 013-3h3v-1.5a3 3 0 013-3zm9 0a3 3 0  3 0 01-3 3A3 3 0 013.75 16.5v-1.5H.75a3 3 0 01-3-3V9a3 3 0 013-3h3v-1.5a3 3 0 013-3zm9 0a3 3 0
                    013 3v1.5h3a3 3 0 013 3v1.5a3 3 0 01-3 3h-3v1.5a3 3 0 01-3 3A3 3 0 0115.75 16.5v-1.5h-3a3 3 0 01-3-3V9a3 3 0 013-3h3v-1.5a3 3 0 013-3z"
                      clipRule="evenodd"
                    />
                  </svg>
                ) : (
