          ...
          <div className="relative text-center px-6 pt-16">
            ...
            >
              ...
              <div className="flex justify-center items-center mb-4 space-x-[3px]">
                ...
                <div className="w-16 dark:bg-white px-0 mx-0 rounded-md h-[3px] bg-muted-foreground"></div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      activeMode === "adjuster"
                        ...
                        : "text-gray-600 dark:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800",
                    )}
                  >
                    Adjuster
                  </button>
