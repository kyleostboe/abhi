            ...
            <AnimatePresence mode="wait">
              {activeMode === "adjuster" && (
                <motion.div
                  ...
                  className="p-4 mb-6 border border-gray-600 rounded-md text-gray-600 font-serif font-black dark:border-gray-700 dark:text-gray-300 max-w-2xl mx-auto shadow-inner"
                >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-0.5 bg-gradient-to-r from-logo-purple-500 to-logo-blue-500 rounded-lg px-0.5 py-0.5 shadow-lg border border-indigo-300">
