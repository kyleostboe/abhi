    ...
    async (notes?: string[]) => {
      ...
      try {
        ...
        if (noteType === "piano") {
          ...
          if (!sampler) {
            log.debug("Piano not loaded, initializing for chord...")
            await loadPiano()
          }
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-0 md:p-8 pt-0 md:pt-24">
      ...
      <div className="relative">
        ...
        <motion.div
          ...
          className="relative w-full md:max-w-4xl md:mx-auto backdrop-blur-lg shadow-none md:shadow-xl overflow-hidden transition-colors rounded-none md:rounded-3xl duration-300 ease-in-out"
          role="application"
        >
