        ...
        {activeMode === "adjuster" ? (
          ...
          <>
            ...
            <div className="space-y-4 mb-[27px]">
              <div className="p-4 max-w-2xl dark:border-logo-rose-700 text-center border-logo-rose-600 mx-auto rounded-md shadow-inner border-2">
            ...
            >
              <div className="p-10 md:p-16 text-center md:py-14 rounded-2xl border-dashed border-gray-600 border-[3px]">
                <motion.div
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <motion.div
                        ...
                        className="font-black text-xs text-purple-300"
                      >
            ...
            <AnimatePresence>
              {audioAnalysis && durationLimits && (
                ...
                >
                  <Alert className="bg-white dark:bg-gray-900 shadow-lg dark:shadow-white/10 p-1 border-2 border-indigo-400 shadow-inner">
              ...
              >
                <Card className="overflow-hidden border-none shadow-lg dark:shadow-white/20 bg-white dark:bg-gray-900 h-full">
                  ...
                  <div className="p-6 space-y-4 font-black">
                    ...
                    <Button
                      className="w-full bg-transparent text-logo-teal-500 border border-logo-teal-500 hover:bg-logo-teal-50 dark:bg-transparent dark:text-logo-teal-500 dark:border-logo-teal-500 dark:hover:bg-logo-teal-900/20 font-serif font-black"
