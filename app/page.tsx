          ...
          <div className="px-6 md:px-10 pb-10 font-serif font-black">
            ...
            {activeMode === "adjuster" ? (
              ...
              <>
                ...
                >
                  <div
                    className="bg-gradient-to-r from-logo-pink to-logo-blue to-logo-green py-3 px-6 dark:from-logo-pink dark:to-logo-blue dark:to-logo-green border-dashed border-0"
                  >
