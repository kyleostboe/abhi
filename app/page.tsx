          ...
          <div className="px-6 md:px-10 font-serif font-black pb-7">
            ...
            <AnimatePresence mode="wait">
              ...
              {activeMode === "timer" && (
                ...
                >
                  <p className="text-center px-4 pt-1.5 text-logo-rose-600 text-xs">
                    Click anywhere to start or pause the timer.
                  </p>
                </motion.div>
              )}
              {activeMode === "encoder" && (
              ...
              >
                ...
                >
                  <div className="flex flex-col gap-6">
                    ...
                    <RecorderSection className="hidden lg:block" inputId="recording-label-desktop" />
                  </div>
                ...
                <RecorderSection className="lg:hidden" inputId="recording-label-mobile" />
