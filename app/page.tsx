                      ...
                      <div className="grid md:grid-cols-2 text-gray-600 pb-2 gap-4">
                        <div className="text-center">
                          ...
                          <input
                            ...
                            className="flex w-full ring-offset-background file:border-0 file:bg-white file:text-xs file:font-medium file:text-foreground placeholder:text-gray-500  disabled:cursor-not-allowed  md:text-xs border-[5px] rounded-[10px] bg-white py-4 px-4 h-11 border-gray-500 mt-1 text-sm font-black text-gray-500 shadow-md"
                          />
                        </div>
                        <div className="text-center">
