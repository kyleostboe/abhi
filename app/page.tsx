            ...
            {activeMode === "adjuster" ? (
              ...
              >
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}>
                  <Card className="overflow-hidden border-none shadow-lg dark:shadow-white/20 bg-white dark:bg-gray-900">
                    <div className="bg-gradient-to-r from-green-500 via-indigo-500 to-green-500 py-4 px-6 dark:from-green-700 dark:via-indigo-700 dark:to-green-700">
                      <h3 className="text-white text-lg flex items-center font-black">
                      ...
                      {timelineEvents.length === 0 ? (
                        ...
                        <>
                          ...
                          <Button
                            ...
                            className="w-full py-4 bg-gradient-to-r from-green-500 via-indigo-500 to-green-500 hover:from-green-600 hover:via-indigo-600 hover:to-green-600 text-white border-none shadow-lg dark:shadow-white/20 font-black"
                          >
                            <div className="flex items-center justify-center">
                              {isGeneratingAudio && (
                          ...
                          <AnimatePresence>
                            {generatedAudioUrl && !isGeneratingAudio && (
                              ...
                              >
                                <div className="bg-white p-4 rounded-lg border border-indigo-500 text-gray-900 dark:text-gray-100">
                                  <h4 className="text-sm font-black text-indigo-700 dark:text-indigo-300 mb-3">
                                    Generated Audio
                                  </h4>
                                  ...
                                  <Button
                                    ...
                                    className="w-full bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white border-none font-black"
                                  >
