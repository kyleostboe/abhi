                      ...
                      <div className="grid md:grid-cols-2 gap-6 text-gray-600 pb-2">
                        <div className="text-center">
                          ...
                          <Input
                            ...
                            className="mt-1 text-xs border-gray-500 focus:border-gray-600 font-black text-gray-500 shadow-inner"
                          />
                        </div>
                        <div className="text-center">
                          ...
                          <Input
                            ...
                            min="1"
                            className="mt-1 text-xs font-black border-gray-500 focus:border-gray-600 text-gray-500 shadow-inner"
                          />
                        </div>
                      </div>
                    </div>
